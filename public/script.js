...
class CreateForm {
    ...
    validation() {
        ...
        if (INPUT_NAME.value) {
            console.log(this.patternName.test(INPUT_NAME.value) ? INPUT_NAME.value : 'Ошибка ввода!')
        }
        if (INPUT_TEL.value) {
            console.log(this._patternTel.test(INPUT_TEL.value) ? INPUT_TEL.value : 'Ошибка ввода!')
        }
        if (INPUT_MAIL.value) {
            console.log(this._patternMail.test(INPUT_MAIL.value) ? INPUT_MAIL.value : 'Ошибка ввода!')
        }
    }
}
